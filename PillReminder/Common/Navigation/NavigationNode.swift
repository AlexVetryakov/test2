...
class NavigationNode: NavigationEventDrivenInterface {
    ...
    final class Configuration {
        ...
        static let shouldThrottleEvents = false
    ...
    func raise<T: NavigationEvent>(event: T, from sender: NavigationEventDrivenInterface) {
